...
import { IAuthor, Author, Genre } from 'app/shared/model/author.model';
...
describe('Service Tests', () => {
    describe('Author Service', () => {
        ...
        beforeEach(() => {
            ...
            elemDefault = new Author(0, 'AAAAAAA', Genre.MALE, currentDate, currentDate, 'AAAAAAA', 'image/png', 'AAAAAAA');
        });
